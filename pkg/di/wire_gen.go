...
func InitializeAPI(cfg config.Config) (*http.ServerHTTP, error) {
	...
	userUseCase := usecase.NewUserUseCase(userRepository, cfg, otpRepository, interfacesHelper, orderRepository)
	...
	orderUseCase := usecase.NewOrderUseCase(orderRepository, userUseCase, couponRepository, cartRepository)
	...
	serverHTTP := http.NewServerHTTP(adminHandler, userHandler, otpHandler, inventoryHandler, categoryHandler, cartHandler, ordeHandler, paymentHandler, salesHandler, couponHAndler, offerHandler)
